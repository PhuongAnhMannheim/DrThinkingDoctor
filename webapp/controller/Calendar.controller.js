sap.ui.define(['jquery.sap.global',
	...
	function(MessageBox, jQuery, Button, Dialog, Label, Popover, List, StandardListItem, Fragment, Controller, JSONModel) {
		...
		var PageController = Controller.extend("DrThinkingDoctor.controller.Calendar", {
						...
						appointments: [
							{
								...
								title: "online review test results Lucas",
								type: "Type02",
								tentative: false
							},
							{
			...
			_createDialog: function () {
				...
				if (!that.oNewAppointmentDialog) {
					...
					that.oNewAppointmentDialog = new Dialog({
						...
						content: [
							sap.ui.xmlfragment("myFrag", "DrThinkingDoctor.view.AppointmentCreate", this)
						],
			...
			_handleSingleAppointment: function (oAppointment) {
				...
				if (!this._oDetailsPopover) {
					...
					this._oDetailsPopover = sap.ui.xmlfragment("myPopoverFrag", "DrThinkingDoctor.view.AppointmentDetail", this);
